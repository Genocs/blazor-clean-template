...
namespace GenocsBlazor.Infrastructure.Services.Identity
{
    public class IdentityService : ITokenService
    {
        ...
        public IdentityService(
            UserManager<BlazorPortalUser> userManager, RoleManager<BlazorPortalRole> roleManager,
            IOptions<AppConfiguration> appConfig, SignInManager<BlazorPortalUser> signInManager,
        ...
        private async Task<string> GenerateJwtAsync(BlazorPortalUser user)
        {
            var token = GenerateEncryptedToken(GetSigningCredentials(), await GetClaimsAsync(user));
            return token;
        }

        private async Task<IEnumerable<Claim>> GetClaimsAsync(BlazorPortalUser user)
        {
