...
using Genocs.BlazorClean.Template.Infrastructure;
...
using Genocs.BlazorClean.Template.Infrastructure.Services;
using Genocs.BlazorClean.Template.Infrastructure.Services.Identity;
using Genocs.BlazorClean.Template.Infrastructure.Shared.Services;
using Genocs.BlazorClean.Template.Server.Localization;
using Genocs.BlazorClean.Template.Server.Managers.Preferences;
using Genocs.BlazorClean.Template.Server.Services;
...
internal static class ServiceCollectionExtensions
{
    ...
    internal static IServiceCollection AddDatabase(
        ...
        IConfiguration configuration)
        => services
            .AddDbContext<BlazorPortalContext>(options => options
    ...
    internal static IServiceCollection AddIdentity(this IServiceCollection services)
    {
        services
            ...
            .AddEntityFrameworkStores<BlazorPortalContext>()
