...
public class UserService : IUserService
{
    ...
    public UserService(UserManager<BlazorPortalUser> userManager,
                       IMapper mapper,
    ...
    private async Task<string> SendVerificationEmail(BlazorPortalUser user, string origin)
    {
    ...
    public async Task<IResult> UpdateRolesAsync(UpdateUserRolesRequest request)
    {
        ...
        if (user.Email == "giovanni.nocco@genocs.com")
        {
    ...
    public async Task<string> ExportToExcelAsync(string searchString = "")
    {
        ...
        string result = await _excelService.ExportAsync(users, sheetName: _localizer["Users"],
            mappers: new Dictionary<string, Func<BlazorPortalUser, object>>
            {
