...
public class RoleService : IRoleService
{
    ...
    public RoleService(RoleManager<BlazorPortalRole> roleManager,
                       IMapper mapper,
    ...
    public async Task<Result<string>> SaveAsync(RoleRequest request)
    {
        if (string.IsNullOrEmpty(request.Id))
        {
            ...
            var response = await _roleManager.CreateAsync(new BlazorPortalRole(request.Name, request.Description));
